...
const STATUS_STYLES: Record<ArticleStatus, string> = {
  ...
  image_keywords_generating: 'bg-violet-100 text-violet-700',
  image_keywords_ready: 'bg-violet-100 text-violet-700',
...
const STATUS_LABELS: Record<ArticleStatus, string> = {
  ...
  image_keywords_generating: 'Generating Keywords',
  image_keywords_ready: 'Image Keywords Ready',
