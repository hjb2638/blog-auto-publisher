...
VALID_TRANSITIONS = {
    ...
    "content_ready": {"content_approved", "content_generating", "cancelled"},
    "content_approved": {"image_keywords_ready", "cancelled"},
    "image_keywords_ready": {"image_searching", "image_keywords_ready", "cancelled"},
    "image_searching": {"images_ready", "failed"},
    "images_ready": {"final_approved", "image_searching", "cancelled"},
    "final_approved": {"publishing", "cancelled"},
